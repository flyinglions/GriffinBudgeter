...
public class Rule {
     ...
     */
    public String doRule(String getToken, int Start) throws IOException {
    ...
    //Rule 5
    private String getFromHashToBreak() throws IOException {
        String returnString = "";
    ...
    //Rule 6
    private String getFromHashToPoint() throws IOException {  
        String returnString = "";
        boolean isMinus = false;
        int breakFirst = playString.indexOf("R-") + 1;
        int breakLast = playString.indexOf(". ");
    ...
    private String getFromAtToFromOrPoint() {
       ...
       returnString = tempString.substring(breakFirst,breakLast);
       SMSHandler.setStart(breakLast);//Added
    ...
    private void handleSpecLocation(int to) throws IOException {
        //LogWriter.log("Doing Special Location");
        isInternet = true;
